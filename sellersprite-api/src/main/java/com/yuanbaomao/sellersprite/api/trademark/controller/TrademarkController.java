...
package com.yuanbaomao.sellersprite.api.trademark.controller;
...
public class TrademarkController {
    ...
    @GetMapping("/detail")
    public Result<TrademarkDetailVo> getBrandDetail(@Valid @ModelAttribute TrademarkDetailRequest request) {
        return Result.success(trademarkService.getBrandDetail(request));
    }
