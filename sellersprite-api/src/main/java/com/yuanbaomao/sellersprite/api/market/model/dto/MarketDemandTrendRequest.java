 ...
 */
@Data
@Schema(description = "选市场-商品需求趋势请求模型")
public class MarketDemandTrendRequest {

    /** 选市场-商品需求趋势请求参数：市场 id；见表 1.2 */
    @NotNull
    @Schema(description = "选市场-商品需求趋势请求参数：市场 id；见表 1.2")
    private SellerSpriteMarketplace marketplace;

    /** 选市场-商品需求趋势请求参数：筛选日期,默认最近30天，最早查询时间为2021年7月份；见表 1.1 */
    @Schema(description = "选市场-商品需求趋势请求参数：筛选日期,默认最近30天，最早查询时间为2021年7月份；见表 1.1")
    private String month;

    /** 选市场-商品需求趋势请求参数：头部Listing数量；10 */
