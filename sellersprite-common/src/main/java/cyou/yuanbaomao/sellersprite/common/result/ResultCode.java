...
public enum ResultCode implements ErrorCode {
    ...
    API_CODE_ALREADY_EXISTS("D409", "接口编码已存在"),
    API_METHOD_PATH_ALREADY_EXISTS("D409", "HTTP方法与接口路径组合已存在"),
    API_NOT_FOUND("D404", "接口资源不存在或已停用"),
    ...
    DICT_ITEM_VALUE_ALREADY_EXISTS("D409", "同类型字典项值已存在"),
    ...
    MARKET_RESEARCH_JOB_NOT_FOUND("R404", "市场调研任务不存在"),
    MARKET_RESEARCH_JOB_NOT_CANCELLABLE("R409", "当前市场调研任务不可取消"),
    MARKET_RESEARCH_JOB_NOT_RETRYABLE("R409", "当前市场调研任务不可重试"),
    MARKET_RESEARCH_INPUT_NOT_ACCEPTABLE("R409", "当前市场调研任务不接受该人工输入"),
    MARKET_RESEARCH_REPORT_NOT_READY("R409", "市场调研报告尚未生成"),
    MARKET_RESEARCH_REPORT_INVALID("R422", "市场调研报告完整性校验失败"),
    MARKET_RESEARCH_ANALYSIS_NOT_FOUND("RA404", "市场调研分析运行不存在"),
    MARKET_RESEARCH_ANALYSIS_NOT_STARTABLE("RA409", "当前市场调研分析不可启动"),
    MARKET_RESEARCH_ANALYSIS_NOT_RETRYABLE("RA409", "当前市场调研分析不可重试"),
    MARKET_RESEARCH_ANALYSIS_NOT_CANCELLABLE("RA409", "当前市场调研分析不可取消"),
