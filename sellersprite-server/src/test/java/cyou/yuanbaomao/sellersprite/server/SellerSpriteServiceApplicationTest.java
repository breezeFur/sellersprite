...
import cyou.yuanbaomao.sellersprite.framework.security.TokenAuthInterceptor;
...
class SellerSpriteServiceApplicationTest {
    ...
    void sellerSpriteRoutesShouldRequireAccessToken() throws Exception {
        ...
        assertThat(result.getResolvedException())
                .isInstanceOf(cyou.yuanbaomao.base.exception.BizException.class)
                .extracting("code")
                .isEqualTo("A401");
    }
    ...
    @Test
    void marketResearchWorkflowRouteShouldRequireAccessToken() throws Exception {
        var result = mockMvc.perform(get("/api/market-research/workflow")).andReturn();
